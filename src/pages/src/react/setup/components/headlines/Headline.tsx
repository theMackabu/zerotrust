...
export default function Headline({ type = '1', style = '', children, className = '' }: HeadlineProps) {
	...
	return <HeadingTag className={`block font-bold text-zinc-900 ${cssClasses} ${className}`}>{children}</HeadingTag>;
}
